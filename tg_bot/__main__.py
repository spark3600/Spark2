...
Hi! This is a modular group management bot to help you manage your groups.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Developer", url="https://t.me/adi_xd")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/+mJVYc0JvB68zM2U1")],
                     [InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))

    else:
        update.effective_message.reply_text("Always on your service...")
